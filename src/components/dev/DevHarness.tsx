...
export function DevHarness({
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed right-4 top-4 z-40 rounded-lg bg-amber-500 px-3 py-2 text-sm font-medium text-white shadow-lg hover:bg-amber-600"
      >
        Dev ⚙️
      </button>
    );
  ...
  return (
    <div className="fixed right-0 top-0 z-40 h-full w-80 overflow-y-auto bg-gray-900 text-gray-100 shadow-2xl">
      {/* Header */}
